...
function t01() {
  out1.textContent = document.querySelector("html").getAttribute("lang");
}
...
function t04() {
  const d3 = document.querySelector("#d-3");
  const d4 = d3.setAttribute("id", "d-4");
  const d41 = document.querySelector("#d-4");
  out4.textContent = d41.textContent;
}
...
function t05() {
  const i5 = document.querySelector(".i-5").setAttribute("type", "password");
}
...
function t06() {
  const i6 = document.querySelector(".i-6").setAttribute("placeholder", "Arch Druidess");
}
...
function t07() {
  ...
  out7.textContent = img7.getAttribute("alt");
}
