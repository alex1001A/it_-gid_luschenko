...
const t09 = function (a, b) {
  return (document.querySelector(".out-9").textContent = a > b ? a : b);
};
...
function t10(a, b) {
  ...
  document.querySelector(".out-10").textContent = randomNumber;
}
...
function t11(a, b, c) {
  return (document.querySelector(".out-11").textContent = Math.max(a, b, c));
}
...
document.querySelector(".b-20").addEventListener("click", function () {
  document.querySelector(".out-20").textContent = t20(true);
});
