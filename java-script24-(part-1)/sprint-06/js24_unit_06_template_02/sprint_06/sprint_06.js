...
function t08() {
  const age = 2024 - +document.querySelector(".i-8").value;
...
function t09() {
  ...
  if (i9 > 0 && i9 <= 36) {
    out9.textContent = "первый";
  } else if (i9 > 36 && i9 <= 87) {
    out9.textContent = "второй";
  } else if (i9 > 87 && i9 <= 110) {
    out9.textContent = "третий";
  } else {
    out9.textContent = 0;
  }
}
...
function t12() {
  document.querySelector(".out-12").textContent = num_1 > num_2 ? num_1 : num_2;
}
...
function t16() {
  const i16 = document.querySelector(".i-16").value.length;
